...
#                                Extracted Window
# =================================================================================
from RadiomicFeatures.Feature440 import featuresV1
class ExtractedWindow:
    def __init__(self, topleft, downright, slice):
        ...
        self.pixel=slice[y1:y0, x0:x1]


    def getFeatures(self):
        return featuresV1(self.pixel)
...
def toggle_selector(event):
    ...
    if event.key in ['Q', 'q'] and toggle_selector.RS.active:
        ...
        print("   选择成功: 左上(%.2f,%.2f) 右下(%.2f,%.2f)"%(xmin,ymax,xmax,ymin))
...
btnCalc = Button(axCalc,   'Calc',color='0.85', hovercolor='0.85')
